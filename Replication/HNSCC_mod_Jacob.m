function [A B] = HNSCC_mod_Jacob(P,Y_starb,U,C_IL2,C_LIF,C_IL8,C_Lac,C_OPN)
syms y_1 y_2 y_3 y_4 y_5 y_6 y_7 y_8 y_9 y_10 y_11 y_12 y_13 y_14 y_15 y_16 y_17 y_18 y_19 y_20 y_21 y_22 y_23 y_24 u_1 u_2 u_3 u_4 u_5 u_6;
y=[y_1; y_2; y_3; y_4; y_5; y_6; y_7; y_8; y_9; y_10; y_11; y_12; y_13; y_14; y_15; y_16; y_17; y_18; y_19; y_20; y_21; y_22; y_23; y_24];
u=[u_1];
...
K_TEX=P(34);               % Proliferation rate of regulator T cells
...
F_ResCST=Res*K_RCST*CST*(1-CST/((1-I)*Y_CST))*1/(alpha_Comp*(CPDL1+CNPDL1)+1);                                            % Resource-driven proliferation of tumor stem cells
...
F_ResCSNT=Res*K_RCSNT*CSNT*(1-CSNT/(I*Y_CST))*1/(alpha_Comp*(CRPDL1+CRNPDL1)+1);                                                % Resource-driven proliferation of tumor stem cells
...
F_ResCNPDL1= Res*K_RCNPDL1*CNPDL1*(1-CNPDL1/((1-I)*Y_CPDL1M))*1/(alpha_Comp*(CST+CPDL1)+1);                                 % Resource-driven proliferation of tumor stem cells
...
F_ResCPDL1= Res*K_RCPDL1*CPDL1*(1-CPDL1/(Y_CPDL1M*(1-I)))*1/(alpha_Comp*(CST+CNPDL1)+1);                                        % Resource-driven proliferation of PDL1 +ve cells
...
F_ResCRNPDL1=Res*K_RCRNPDL1*CRNPDL1*(1-CRNPDL1/(I*Y_CPDL1M))*1/(alpha_Comp*(CSNT+CRPDL1)+1);                                        % Resource-driven proliferation of Non-PDL1, Non T-exposed tumor cells
...
F_ResCRPDL1= Res*K_RCRPDL1*CRPDL1*(1-CRPDL1/(I*Y_CPDL1M))*1/(alpha_Comp*(CSNT+CNPDL1)+1);                                              % Resource-driven proliferation of Non-PDL1, Non T-exposed tumor cells
...
F_ProTKPD1=K_TKPD*TKPD1*(1-TKPD1/(Y_TKM-TEX-TKNPD1));                                                % Proliferation of killer, PD1+ve T-cells
...
% Killer PD1- T cells
F_ProTKNPD1=K_TKNPD*TKNPD1*u*(1-TKNPD1/(Y_TKM-TEX-TKPD1));                                                      % Proliferation of killer, PD1+ve T-cells
...
% Exhausted T cells
F_ProTEX=K_TEX*TEX*(1-TEX/(Y_TKM-TKPD1-TKNPD1));
...
F_ProFWT=K_FWT*FWT*(1-FWT/(Y_FWTM-CAF));                                               % Proliferation of Wild-type fibroblasts
...
F_ProCAF=K_CAF*CAF*(1-CAF/(Y_FWTM-FWT));                                               % Proliferation of CAFs
...
F_ProMACM1= K_M1*MACM1*(1-MACM1/(Y_MM-MACM2));                                          % Proliferation of M1 macrophage
...
F_ProMACM2=K_M2*MACM2*(1-MACM2/(Y_MM-MACM1));                                        % Proliferation of M2 macrophage
...
%Y_starb=x(length(t),:);
for l=1:length(dydt)
J1=subs(J1,y(l),Y_starb(l));
J2=subs(J2,y(l),Y_starb(l));
end
J1= subs(J1,u(1),U(1));
J2=subs(J2,u(1),U(1));
A= double(J1);
