...
alpha=0.3;                     % Ensuring low immune index
K_P_CAF1=[0:0.1:1];            % Proliferation rate of CAF
K_P_CAF2=[1.1:2:10.1];
K_P_CAF1=[0:0.01:1];
K_P_CAF=[K_P_CAF1 K_P_CAF2];
clc
P=HNSCC_parameters(alpha);
P(11)=20;                     % Setting the CAf-induced proliferation rate of tumor cells
...
P(49)=K_P_CAF(length(K_P_CAF)-l+1);  % Varying the proliferation rate of CAFs
P(48)=0.01;                          % Ensuring low proliferation for wild type fibroblasts 
[t_pre,x_pre]=ode23s(@(t,y)HNSCC_mod_Res_Comp(t,y,0,0,0,0,0,0,P),[0 70000],y_0);
I=(1-tanh(alpha*P(20)*x_pre(:,14)));              % Calculation of Immune accessibility index
subplot(1,2,1)
